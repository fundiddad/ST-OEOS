<template>
  ...
  >
    <div
      ...
      style="position: fixed; left:0; top:0; width: 300px; height: 300px; overflow: hidden;"
    ></div>
    <div
...
export default {
  ...
  methods: {
    ...
    runTease() {
      ...
      this.authNoSleep()
      if (this.allowNoSleep) this.noSleep.enable()
...
.oeos-outer .v-btn.v-size--default {
  height: auto;
  min-height: 36px;
  font-size: 1.1rem;
...
.oeos-outer .v-btn.v-size--default.expand-x-transition-enter-active,
.oeos-outer .v-btn.v-size--default.expand-x-transition-leave-active {
  height: 36px;
}

.oeos-outer .v-btn.v-size--small {
  height: auto;
  min-height: 26px;
  font-size: 1rem;
  font-family: 'Noto Sans', sans-serif;
...
.oeos-outer .v-btn.v-size--small.expand-x-transition-enter-active {
  height: 26px;
}

.oeos-outer .v-btn.v-size--default .v-btn__content {
  max-width: 100%;
}

.oeos-outer .v-btn.v-size--default .v-btn__content > span {
  white-space: normal;
}
